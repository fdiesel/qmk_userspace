 ...
 */
    [_QWERTY] = LAYOUT_split_3x6_5_hlc(
     ...
     CTL_ESC , HR_A ,  HR_S   ,  HR_D  ,   HR_F ,   KC_G ,                                         KC_H ,   HR_J ,  HR_K ,   HR_L , CU_OE ,  CU_AE ,
     KC_LSFT , KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B , LGUI(LALT(KC_K)),LGUI(LSFT(KC_S)),     CU_IDLE, FKEYS  ,  KC_N ,   KC_M ,KC_COMM, KC_DOT ,KC_SLSH,  KC_ENT,
                                ADJUST , KC_LGUI, ALT_ENT, CMD,FUN    ,     NAV    , SYM    ,NUMBERS, KC_RGUI, KC_APP,
 ...
 */
    [_SYM] = LAYOUT_split_3x6_5_hlc(
      KC_GRV ,  KC_AT ,  KC_2  ,  CU_EU ,   KC_4 , KC_TILD,                                     KC_HASH, KC_RPRN, KC_RCBR, KC_RBRC, KC_PLUS, KC_EQL,
     KC_TILD , KC_AMPR,  CU_SU , KC_DLR ,LSFT(KC_1), LSFT(KC_8),                                KC_COLN, KC_LPRN, KC_LCBR, KC_LBRC, KC_SCLN, KC_MINS,
     KC_PIPE , KC_PIPE, KC_COLN, KC_SCLN, KC_MINS, KC_LBRC, KC_LCBR, _______, _______, KC_RCBR, KC_PERC, CU_QUOT, CU_DQUO, CU_GRV , KC_BSLS, RSFT(KC_MINS),
 ...
 */
    [_NAV] = LAYOUT_split_3x6_5_hlc(
      ...
      _______, KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, _______,                                     KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_VOLD, _______,
      _______, _______, _______, _______, _______, _______, _______, KC_SCRL, _______, _______,KC_PAUSE, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     _______, _______,  _______, _______, _______,                                                       _______, _______, _______, _______, _______
    ),
 ...
 * `-----------------------------------'                                              `-----------------------------------'
 */
    [_CMD] = LAYOUT_split_3x6_5_hlc(
      _______, _______, _______, _______, _______, _______,                                     _______, _______, KC_INS , _______, KC_PSCR, _______,
      _______, _______, KC_SCRL, KC_DEL , _______, _______,                                     _______, _______, _______, _______, _______, _______,
